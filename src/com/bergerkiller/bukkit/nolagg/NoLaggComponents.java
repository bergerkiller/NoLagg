...
public enum NoLaggComponents {
	...
	private NoLaggComponents(String name, String description) {
		this(name, "com.bergerkiller.bukkit.nolagg." + name.toLowerCase() + ".NoLagg" + name, description);
	}

	private NoLaggComponents(String name, String mainclass, String description) {
		this.enabled = false;
		this.name = name;
