...
public class ChunkCompressQueue {
    ...
    public boolean isAlive() {
    	if (this.owner.ep.netServerHandler == null) return false;
    	if (this.owner.ep.netServerHandler.disconnected) return false;
    	return true;
    }
    ...
    public Chunk pollChunk() {
    	Chunk chunk;
        synchronized (this.toCompress) {
        	if (this.toCompress.isEmpty()) return null;
